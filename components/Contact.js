  ...
  return (
    <section className="bg-white dark:bg-gray-800">
      <div className="relative bg-slate-100 dark:bg-gray-800 px-[8vw] py-12">
        ...
        <p className=" border-l-8 border-purple-400 pl-2 text-6xl font-bold my-8">
          Contact
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="md:ml-4">
            <header className="">
              ...
              <p className="font-light text-lg dark:text-gray-200 text-gray-500 mt-6 mr-10">
                Fill in the details and I'll get back to you as soon as I can.
              </p>
              <p className="font-light text-lg dark:text-gray-200 text-gray-500 mt-1 mr-10">
                You can also reach me via LinkedIn by Phone.
              </p>
            </header>
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row items-center space-x-6 rounded-md border  border-transparent hover:border hover:border-gray-400 py-4">
                <svg
                ...
                <p className="text-gray-800 dark:text-gray-50 font-light text-lg">
                  {userData.phone}
                </p>
              </div>
              <div className="flex flex-row items-center space-x-6 rounded-md border  border-transparent hover:border hover:border-gray-400 py-4">
          ...
          >
            <label htmlFor="name" className="text-lg mx-4 mt-4">
              Your Name
            </label>
            <input
              type="text"
            ...
            />
            <label htmlFor="email" className="text-lg mx-4 mt-4">
              Email
            </label>
            <input
              type="text"
              ...
              onChange={handleTextChange}
            />
            <label htmlFor="message" className="text-lg mx-4 mt-4">
              Message
            </label>
            <textarea
              rows="4"
